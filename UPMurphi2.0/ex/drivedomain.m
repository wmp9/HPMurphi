...
f_n := 0;
at[car][tstart]:= true; 
speed[car] := 0.000000000;
maxspeed[car] := 10.00000000;
traveltime[car] := 0.000000000;
distance[tstart][tend] := 100.0000000;
...
goal "enjoy" 
 (at[car][tend]) & ((( traveltime[car]) >= (20.00000000))); 
