...
( !fly_clock_started[from][tto]) & (at[from]) & (!((from)=(tto))) ==> 
pddlname: " fly"; 
BEGIN
...
( fly_clock_started[from][tto]) & (( fly_clock[from][tto]) = (distance[from][tto])) ==> 
pddlname: " fly"; 
BEGIN
...
( !dospiral_clock_started[from][tto][p]) & (beginat[from][p]) & (endat[tto][p]) & (at[from]) ==> 
pddlname: " dospiral"; 
BEGIN
...
( dospiral_clock_started[from][tto][p]) & (( dospiral_clock[from][tto][p]) = (timefor[p])) ==> 
pddlname: " dospiral"; 
BEGIN
