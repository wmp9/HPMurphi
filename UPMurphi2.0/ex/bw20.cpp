/******************************
  Program "bw20.m" compiled by "Universal Planner Murphi Release 2.0.R8"
...
#define PROTOCOL_NAME "bw20"
#define BITS_IN_WORLD 979
#define HASHC
...
class mu_1_block: public mu__byte
{
 public:
  ...
  mu_1_block (const char *name, int os): mu__byte(1, 20, 5, name, os) {};
  mu_1_block (void): mu__byte(1, 20, 5) {};
  mu_1_block (int val): mu__byte(1, 20, 5, "Parameter or function result.", 0)
  {
     operator=(val);
  };
...
const char *mu_1_block::values[] = {"b1","b2","b3","b4","b5","b6","b7","b8","b9","b10","b11","b12","b13","b14","b15","b16","b17","b18","b19","b20",NULL };
...
friend int Compare(mu_1__type_0& a, mu_1__type_0& b)
  ...
  std::vector<mu_0_boolean*> bool_array() {
	...
	#ifdef awesome_mu_00_mu_0_boolean_mu_1__type_0
		for (int ix = 0; ix < 20; ix++){ barr.push_back(&(array[ix])); }
		return barr;
	#else 
		for (int ix = 0; ix < 20; ix++){
			for (int ix2 = 0; ix2 < 20; ix2++){ barr.push_back(&(array[ix][ix2+1])); }
		}
		return barr;
...
if (n) array[i].set_self_ar(n,"b1", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"b2", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"b3", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"b4", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"b5", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"b6", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"b7", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"b8", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"b9", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"b10", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"b11", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"b12", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"b13", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"b14", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"b15", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"b16", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"b17", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"b18", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"b19", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
if (n) array[i].set_self_ar(n,"b20", i * 40 + os); else array[i].set_self_ar(NULL, NULL, 0); i++;
  }
...
/*** Variable declaration ***/
mu_1__type_2 mu_ontable("ontable",857);

/*** Variable declaration ***/
mu_1__type_3 mu_isclear("isclear",897);

/*** Variable declaration ***/
mu_0_boolean mu_handempty("handempty",937);

/*** Variable declaration ***/
mu_1__type_4 mu_holding("holding",939);
...
bool mu__boolexpr9;
  ...
  void NextRule(RULE_INDEX_TYPE & what_rule)
  {
    RULE_INDEX_TYPE r = what_rule - 401;
    static mu_1_block mu_y;
    mu_y.value((r % 20) + 1);
    r = r / 20;
    static mu_1_block mu_x;
...
public:
  ...
  void NextRule(RULE_INDEX_TYPE & what_rule)
  {
    RULE_INDEX_TYPE r = what_rule - 801;
    static mu_1_block mu_x;
    mu_x.value((r % 20) + 1);
    r = r / 20;
    while (what_rule < 821 )
...
bool mu__boolexpr12;
  ...
  void NextRule(RULE_INDEX_TYPE & what_rule)
  {
    RULE_INDEX_TYPE r = what_rule - 821;
    static mu_1_block mu_x;
    mu_x.value((r % 20) + 1);
    r = r / 20;
    while (what_rule < 841 )
...
void SetNextEnabledRule(RULE_INDEX_TYPE & what_rule)
{
  ...
  if (what_rule>=1 && what_rule<401)
    { R1.NextRule(what_rule);
      if (what_rule<401) return; }
  if (what_rule>=401 && what_rule<801)
    { R2.NextRule(what_rule);
      if (what_rule<801) return; }
  if (what_rule>=801 && what_rule<821)
    { R3.NextRule(what_rule);
      if (what_rule<821) return; }
  if (what_rule>=821 && what_rule<841)
    { R4.NextRule(what_rule);
      if (what_rule<841) return; }
}
bool Condition(RULE_INDEX_TYPE r)
{
  category = CONDITION;
  if (r<=0) return R0.Condition(r-0);
  if (r>=1 && r<=400) return R1.Condition(r-1);
  if (r>=401 && r<=800) return R2.Condition(r-401);
  if (r>=801 && r<=820) return R3.Condition(r-801);
  if (r>=821 && r<=840) return R4.Condition(r-821);
...
std::vector<mu_0_boolean*> precond_array(RULE_INDEX_TYPE r)
{
  ...
  if (r>=1 && r<=400) return R1.precond_array(r-1);
  if (r>=401 && r<=800) return R2.precond_array(r-401);
  if (r>=801 && r<=820) return R3.precond_array(r-801);
  if (r>=821 && r<=840) return R4.precond_array(r-821);
Error.Notrace("Internal: NextStateGenerator -- checking preconditions for nonexisting rule.");
}
std::vector<mu_0_boolean*> effects_array(RULE_INDEX_TYPE r)
{
  if (r<=0) return R0.effects_array(r-0);
  if (r>=1 && r<=400) return R1.effects_array(r-1);
  if (r>=401 && r<=800) return R2.effects_array(r-401);
  if (r>=801 && r<=820) return R3.effects_array(r-801);
  if (r>=821 && r<=840) return R4.effects_array(r-821);
Error.Notrace("Internal: NextStateGenerator -- checking effects for nonexisting rule.");
}
std::vector<mu_0_boolean*> effects_add_array(RULE_INDEX_TYPE r)
{
  if (r<=0) return R0.effects_add_array(r-0);
  if (r>=1 && r<=400) return R1.effects_add_array(r-1);
  if (r>=401 && r<=800) return R2.effects_add_array(r-401);
  if (r>=801 && r<=820) return R3.effects_add_array(r-801);
  if (r>=821 && r<=840) return R4.effects_add_array(r-821);
Error.Notrace("Internal: NextStateGenerator -- checking add effects for nonexisting rule.");
}
void Code(RULE_INDEX_TYPE r)
{
  if (r<=0) { R0.Code(r-0); return; } 
  if (r>=1 && r<=400) { R1.Code(r-1); return; } 
  if (r>=401 && r<=800) { R2.Code(r-401); return; } 
  if (r>=801 && r<=820) { R3.Code(r-801); return; } 
  if (r>=821 && r<=840) { R4.Code(r-821); return; } 
}
void Code_ff(RULE_INDEX_TYPE r)
{
  if (r<=0) { R0.Code_ff(r-0); return; } 
  if (r>=1 && r<=400) { R1.Code_ff(r-1); return; } 
  if (r>=401 && r<=800) { R2.Code_ff(r-401); return; } 
  if (r>=801 && r<=820) { R3.Code_ff(r-801); return; } 
  if (r>=821 && r<=840) { R4.Code_ff(r-821); return; } 
}
int Priority(RULE_INDEX_TYPE r)
{
  if (r<=0) { return R0.Priority(); } 
  if (r>=1 && r<=400) { return R1.Priority(); } 
  if (r>=401 && r<=800) { return R2.Priority(); } 
  if (r>=801 && r<=820) { return R3.Priority(); } 
  if (r>=821 && r<=840) { return R4.Priority(); } 
}
char * Name(RULE_INDEX_TYPE r)
{
  if (r<=0) return R0.Name(r-0);
  if (r>=1 && r<=400) return R1.Name(r-1);
  if (r>=401 && r<=800) return R2.Name(r-401);
  if (r>=801 && r<=820) return R3.Name(r-801);
  if (r>=821 && r<=840) return R4.Name(r-821);
  return NULL;
}
int Duration(RULE_INDEX_TYPE r)
{
  if (r<=0) return R0.Duration(r-0);
  if (r>=1 && r<=400) return R1.Duration(r-1);
  if (r>=401 && r<=800) return R2.Duration(r-401);
  if (r>=801 && r<=820) return R3.Duration(r-801);
  if (r>=821 && r<=840) return R4.Duration(r-821);
Error.Notrace("Internal: NextStateGenerator -- querying duration for nonexisting rule.");
}
int Weight(RULE_INDEX_TYPE r)
{
  if (r<=0) return R0.Weight(r-0);
  if (r>=1 && r<=400) return R1.Weight(r-1);
  if (r>=401 && r<=800) return R2.Weight(r-401);
  if (r>=801 && r<=820) return R3.Weight(r-801);
  if (r>=821 && r<=840) return R4.Weight(r-821);
Error.Notrace("Internal: NextStateGenerator -- querying duration for nonexisting rule.");
}
char * PDDLName(RULE_INDEX_TYPE r)
{
  if (r<=0) return R0.PDDLName(r-0);
  if (r>=1 && r<=400) return R1.PDDLName(r-1);
  if (r>=401 && r<=800) return R2.PDDLName(r-401);
  if (r>=801 && r<=820) return R3.PDDLName(r-801);
  if (r>=821 && r<=840) return R4.PDDLName(r-821);
  return NULL;
}
RuleManager::rule_pddlclass PDDLClass(RULE_INDEX_TYPE r)
{
  if (r<=0) return R0.PDDLClass(r-0);
  if (r>=1 && r<=400) return R1.PDDLClass(r-1);
  if (r>=401 && r<=800) return R2.PDDLClass(r-401);
  if (r>=801 && r<=820) return R3.PDDLClass(r-801);
  if (r>=821 && r<=840) return R4.PDDLClass(r-821);
Error.Notrace("Internal: NextStateGenerator -- querying PDDL class for nonexisting rule.");
}
};
const RULE_INDEX_TYPE numrules = 841;

/********************
  parameter
 ********************/
#define RULES_IN_WORLD 841
...
public:
  ...
  {
{
for(int mu_x = 1; mu_x <= 20; mu_x++) {
{
for(int mu_y = 1; mu_y <= 20; mu_y++) {
...
mu_f_n = 0;
mu_handempty = mu_true;
mu_on[mu_b1][mu_b2] = mu_true;
mu_on[mu_b2][mu_b5] = mu_true;
mu_on[mu_b3][mu_b15] = mu_true;
mu_on[mu_b4][mu_b14] = mu_true;
mu_on[mu_b5][mu_b12] = mu_true;
mu_on[mu_b6][mu_b8] = mu_true;
mu_on[mu_b7][mu_b3] = mu_true;
mu_ontable[mu_b8] = mu_true;
mu_on[mu_b9][mu_b7] = mu_true;
mu_ontable[mu_b10] = mu_true;
mu_on[mu_b11][mu_b1] = mu_true;
mu_on[mu_b12][mu_b17] = mu_true;
mu_on[mu_b13][mu_b20] = mu_true;
mu_on[mu_b14][mu_b9] = mu_true;
mu_on[mu_b15][mu_b18] = mu_true;
mu_on[mu_b16][mu_b6] = mu_true;
mu_ontable[mu_b17] = mu_true;
mu_on[mu_b18][mu_b10] = mu_true;
mu_on[mu_b19][mu_b16] = mu_true;
mu_ontable[mu_b20] = mu_true;
mu_isclear[mu_b4] = mu_true;
mu_isclear[mu_b11] = mu_true;
mu_isclear[mu_b13] = mu_true;
mu_isclear[mu_b19] = mu_true;
  };
...
bool mu__boolexpr29;
bool mu__boolexpr30;
  if (!(mu_on[mu_b1][mu_b16])) mu__boolexpr30 = FALSE ;
  else {
  mu__boolexpr30 = (mu_on[mu_b3][mu_b17]) ; 
}
  if (!(mu__boolexpr30)) mu__boolexpr29 = FALSE ;
  else {
  mu__boolexpr29 = (mu_on[mu_b4][mu_b11]) ; 
}
  if (!(mu__boolexpr29)) mu__boolexpr28 = FALSE ;
  else {
  mu__boolexpr28 = (mu_on[mu_b5][mu_b3]) ; 
}
  if (!(mu__boolexpr28)) mu__boolexpr27 = FALSE ;
  else {
  mu__boolexpr27 = (mu_on[mu_b6][mu_b14]) ; 
}
  if (!(mu__boolexpr27)) mu__boolexpr26 = FALSE ;
  else {
  mu__boolexpr26 = (mu_on[mu_b7][mu_b5]) ; 
}
  if (!(mu__boolexpr26)) mu__boolexpr25 = FALSE ;
  else {
  mu__boolexpr25 = (mu_on[mu_b8][mu_b1]) ; 
}
  if (!(mu__boolexpr25)) mu__boolexpr24 = FALSE ;
  else {
  mu__boolexpr24 = (mu_on[mu_b10][mu_b12]) ; 
}
  if (!(mu__boolexpr24)) mu__boolexpr23 = FALSE ;
  else {
  mu__boolexpr23 = (mu_on[mu_b11][mu_b15]) ; 
}
  if (!(mu__boolexpr23)) mu__boolexpr22 = FALSE ;
  else {
  mu__boolexpr22 = (mu_on[mu_b12][mu_b18]) ; 
}
  if (!(mu__boolexpr22)) mu__boolexpr21 = FALSE ;
  else {
  mu__boolexpr21 = (mu_on[mu_b13][mu_b6]) ; 
}
  if (!(mu__boolexpr21)) mu__boolexpr20 = FALSE ;
  else {
  mu__boolexpr20 = (mu_on[mu_b14][mu_b10]) ; 
}
  if (!(mu__boolexpr20)) mu__boolexpr19 = FALSE ;
  else {
  mu__boolexpr19 = (mu_on[mu_b15][mu_b20]) ; 
}
  if (!(mu__boolexpr19)) mu__boolexpr18 = FALSE ;
  else {
  mu__boolexpr18 = (mu_on[mu_b16][mu_b9]) ; 
}
  if (!(mu__boolexpr18)) mu__boolexpr17 = FALSE ;
  else {
  mu__boolexpr17 = (mu_on[mu_b17][mu_b19]) ; 
}
  if (!(mu__boolexpr17)) mu__boolexpr16 = FALSE ;
  else {
  mu__boolexpr16 = (mu_on[mu_b20][mu_b2]) ; 
}
return mu__boolexpr16;
  ...
  std::set<mu_0_boolean*> get_goal_conditions()
  {
    std::set<mu_0_boolean*> goal_conds;
		...
		goal_conds.insert(&(mu_on[mu_b10][mu_b12])); 
		goal_conds.insert(&(mu_on[mu_b11][mu_b15])); 
		goal_conds.insert(&(mu_on[mu_b12][mu_b18])); 
		goal_conds.insert(&(mu_on[mu_b13][mu_b6])); 
		goal_conds.insert(&(mu_on[mu_b14][mu_b10])); 
		goal_conds.insert(&(mu_on[mu_b15][mu_b20])); 
		goal_conds.insert(&(mu_on[mu_b16][mu_b9])); 
		goal_conds.insert(&(mu_on[mu_b17][mu_b19])); 
		goal_conds.insert(&(mu_on[mu_b1][mu_b16])); 
		goal_conds.insert(&(mu_on[mu_b20][mu_b2])); 
		goal_conds.insert(&(mu_on[mu_b3][mu_b17])); 
		goal_conds.insert(&(mu_on[mu_b4][mu_b11])); 
		goal_conds.insert(&(mu_on[mu_b5][mu_b3])); 
		goal_conds.insert(&(mu_on[mu_b6][mu_b14])); 
		goal_conds.insert(&(mu_on[mu_b7][mu_b5])); 
		goal_conds.insert(&(mu_on[mu_b8][mu_b1])); 

    return goal_conds;
  }

bool mu__condition_31() // Condition for Rule "enjoy"
{
  return mu__goal_15( );
}

bool mu__goal__00(){ return mu__condition_31(); } /* WP WP WP GOAL CONDITION CHECK */ /**** end rule declaration ****/


// WPGOAL
const rulerec goals[] = {
{"enjoy", &mu__condition_31, NULL, },
};
