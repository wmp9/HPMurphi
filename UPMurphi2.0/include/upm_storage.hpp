...
public:
	...
	void actionwriter_actiontext(unsigned long from, RULE_INDEX_TYPE rule, unsigned long to) {WriteTextAction(from, rule, to, false, false);}	
	void actionwriter_actiontext_verbose(unsigned long from, RULE_INDEX_TYPE rule, unsigned long to) {WriteTextAction(from, rule, to, true, true);}		
	void actionwriter_actionbin(unsigned long from, RULE_INDEX_TYPE rule, unsigned long to) {WriteBinaryAction(from, rule, to);}		
	void actionwriter_actioncsv(unsigned long from, RULE_INDEX_TYPE rule, unsigned long to) {WriteCSVAction(from, rule, to);}	
