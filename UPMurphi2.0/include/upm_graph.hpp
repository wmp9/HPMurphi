...
public:	
	...
	RULE_INDEX_TYPE OutDegree(unsigned long from) {return out_degree[from];};
	unsigned long OutDegreeTot();
	RULE_INDEX_TYPE OutDegreeMin();
	RULE_INDEX_TYPE OutDegreeMax();
	double OutDegreeAvg();
	unsigned long NumStates();
	unsigned long MaxElts() { return max_transitions; };
...
public:	
	...
	virtual const char* ModeLabel() {return "Memory Image";};
...
public:	
	...
	virtual const char* ModeLabel() {return "Indexed Disk Image";};
