...
public:
  ...
  state_queue *getQueue() { return queue; }
  ...
  inline unsigned long Capacity() {return the_states->Capacity();}
  ...
  inline long CurrentLevel() {return currentLevel;}  
...
public:
	...
	void simulate();
	char Phase() { return phase; }
	unsigned long ControlledStates() { return num_controlled_states; }
	//stats
	unsigned long NumPlans() { return num_plans; }
	unsigned MaxPlanLen() { return max_plan_length; }
	unsigned MinPlanLen() { return min_plan_length; }
	float AvgPlanLen() { return avg_plan_length; }
	//
	unsigned MaxPlanDuration() { return max_plan_duration; }
	unsigned MinPlanDuration() { return min_plan_duration; }
	float AvgPlanDuration() { return avg_plan_duration; }
	//
	unsigned MaxPlanWeight() { return max_plan_weight; }
	unsigned MinPlanWeight() { return min_plan_weight; }
	float AvgPlanWeight() { return avg_plan_weight; }
};
