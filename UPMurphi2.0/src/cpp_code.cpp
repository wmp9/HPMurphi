...
*/  
  ...
  switch(pddlclass) {
	  case Event: fprintf(codefile, "    return RuleManager::Event;\n"); break;
	  case DurativeStart: fprintf(codefile, "    return RuleManager::DurativeStart;\n"); break;
	  case DurativeEnd: fprintf(codefile, "    return RuleManager::DurativeEnd;\n"); break;
	  case Clock: fprintf(codefile, "    return RuleManager::Clock;\n"); break;
	  case Action: fprintf(codefile, "    return RuleManager::Action;\n"); break;
	  default: fprintf(codefile, "    return RuleManager::Other;\n"); break;
  }
  fprintf(codefile, "  };\n" "\n");
