...
struct simplerule:rule {
  ...
  //UPMURPHI_BEGIN
  virtual rule_pddlclass getpddlclass() {return pddlclass;};
  virtual void setpddlclass(rule_pddlclass cl) {pddlclass=cl;};
  
  virtual expr *getduration() {return duration;};
  virtual void setduration(expr * e) {duration=e;};
  
  virtual expr *getweight() {return weight;};
  virtual void setweight(expr * e) {weight=e;};

  virtual char *get_pddlname() {return (pddlname!=NULL?pddlname:name);};
  virtual void set_pddlname(char *name) {pddlname=name;};
  //UPMURPHI_END
